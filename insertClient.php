<?php
    ...
    if(isset($_POST['submit'])){
      ...
      $sql5 .="(SS_NUMBER, ACT_TREAT, INTGR_TREAT, PROGRAM_CODE, DSC_ID) ";
      $sql5 .= "VALUES ('$SS_NUMBER', '$ACT_TREAT', '$INTGR_TREAT', '.$PROGRAM_CODE','$ID') ";
 

      $sql6 = "INSERT INTO Services ";
      $sql6 .="(SS_NUMBER, INAPT_SERV, RESID_SERV, PARTI_SERV, OUTPA_SERV, CASEM_SERV, DSC_ID) ";
      $sql6 .= "VALUES ( '$SS_NUMBER','$INAPT_SERV','$RESID_SERV', '$PARTI_SERV','$OUTPA_SERV', '$CASEM_SERV', '$ID') ";
